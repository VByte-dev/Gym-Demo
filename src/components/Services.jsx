...
const services = [
  {
    ...
    desc: 'One-on-one sessions tailored to your body, goals, and schedule. Your coach builds a plan that evolves with you.',
    img: 'https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?w=600',
  },
  {
    name: 'Group Training',
    desc: 'High-energy group classes designed to push you further through motivation, competition, and community.',
    img: 'https://images.unsplash.com/photo-1518611012118-696072aa579a?w=600',
  },
  {
    name: 'Corporate Training',
    desc: 'Bring wellness to your workplace with custom fitness programs that boost productivity and team morale.',
...
export default function Services() {
  ...
  return (
    <section id="program" className="bg-background py-24 md:py-32">
                ...
                >
                  <div className="flex items-center justify-between gap-4">
                    <div className="flex items-center gap-4">
                      <span className={`font-display text-2xl transition-colors duration-300 ${isActive ? 'text-primary' : 'text-muted'}`}>
                        0{i + 1}
                      </span>
                      <h3
