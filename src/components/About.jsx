			...
			>
				<div>
					...
					<p className="text-muted-foreground leading-relaxed mb-4 text-lg">
						At Seven Gym, fitness is about more than just lifting weights.
						Under our experienced guidance, hundreds of members have transformed
						their fitness, and their lives.
					</p>
					<p className="text-muted-foreground leading-relaxed mb-8">
						Located in Mathur, Chennai, our friendly coaching and proven programs
					...
					<div className="flex flex-wrap gap-3 mb-8">
						{highlights.map((h) => (
							<div
								key={h.label}
								className="flex items-center w-full justify-center md:w-fit gap-2 bg-card border border-border rounded-full px-4 py-2"
							>
				...
				<div className="relative">
					<img
						...
						className="rounded-2xl w-full object-cover aspect-[4/5] border border-yellow-400"
						loading="lazy"
					/>
					{/* Floating card */}
					<div className="w-full md:w-fit absolute -bottom-6 md:-left-8 bg-card border border-yellow-400 border-border rounded-2xl p-5 flex items-center gap-4 shadow-2xl">
