...
const trainers = [
  {
    ...
    bio: '8+ years transforming bodies with science-backed strength programs.',
  },
  {
    name: 'Liam CrossFit',
    role: 'CrossFit & HIIT',
    img: 'https://images.unsplash.com/photo-1583454110551-21f2fa2afe61?w=600',
    bio: 'Former competitive athlete turned coach. Specializes in high-intensity training.',
  },
  {
    name: 'Logan Tannar',
    role: 'Yoga & Mobility',
    img: 'https://images.unsplash.com/photo-1526506118085-60ce8714f8c5?w=600',
    bio: 'Certified yoga instructor focused on recovery, flexibility, and mind-body balance.',
  },
];
          ...
          {trainers.map((t, i) => (
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6">
                ...
                <p className="text-primary text-sm uppercase tracking-widest mb-3">{t.role}</p>

                {/* Hover reveal */}
                <div className={`overflow-hidden transition-all duration-500 ${hovered === i ? 'max-h-32 opacity-100' : 'max-h-0 opacity-0'}`}>
                  <p className="text-muted-foreground text-sm mb-4">{t.bio}</p>
