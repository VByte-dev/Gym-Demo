					...
					{plans.map((p) => (
						<div
							...
							className={`rounded-2xl p-8 border transition-all duration-300 relative group hover:-translate-y-1  ${
								p.popular
									? 'bg-gradient-to-b from-primary/10 to-black border-primary'
									: 'bg-gradient-to-bl from-black via-neutral-900 to-black border-border hover:border-primary/40'
							}`}
						>
							{p.popular && (
							...
							<a
								href="#"
								className={`text-center font-bold py-3.5 rounded-full transition-all duration-300 mb-8 flex items-center justify-center gap-2 group/btn ${
									p.popular
